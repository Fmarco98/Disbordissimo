...
/**
 * <h1>TestVoiceChatConnection CommandResponse</h1>
 * Logic to respond to the command "test-voice-chat-connection".
 */
    ...
    public JsonIO.Resp onPerformed(String... params) {
        ...
        try {
            ...
            return JsonIO.genSuccessResponse(List.of(String.valueOf(
                    DisbordissimoServer.getServer().getActiveVoiceChannels().getVoiceChannel(userID) == channelID
            )));
