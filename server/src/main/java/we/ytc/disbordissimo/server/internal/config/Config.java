...
public class Config {
    ...
    /**
     * Loads and validate the config. If it doesn't exist, it will be autogenerated.
     *
     * If an invalid config is loaded the process will be terminated.
     *
    ...
    /**
     * Validate the {@code config}.
     * During the validation, every failed check is shown to the user.
     *
     * @param conf
     *        {@link Config} object
     *
     * @return {@code true} if is a valid config;
